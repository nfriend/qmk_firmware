...
// window management
#define WINDOW_MANAGEMENT_MAC 7
#define WINDOW_MANAGEMENT_WINDOWS 8

// navigation
#define ARROWS_MAC 9
#define ARROWS_WINDOWS 10
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_ergodox(_______,_______,_______,_______,_______,_______,_______,_______,LGUI(KC_Q),LGUI(KC_W),LGUI(KC_F),LGUI(KC_P),LGUI(KC_G),_______,_______,KC_LCTRL,KC_LGUI,KC_LSHIFT,KC_LALT,LGUI(KC_D),_______,LGUI(KC_Z),LGUI(KC_X),LGUI(KC_C),LGUI(KC_V),LGUI(KC_B),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,RGUI(KC_J),KC_BSPACE,KC_UP,KC_DELETE,RGUI(KC_SCOLON),_______,RGUI(KC_H),KC_LEFT,KC_DOWN,KC_RIGHT,KC_ENTER,_______,_______,RGUI(KC_K),RGUI(KC_M),RGUI(KC_COMMA),RGUI(KC_DOT),RGUI(KC_SLASH),_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______),

  [4] = LAYOUT_ergodox(_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_NO,KC_ESCAPE,LALT(KC_KP_MINUS),KC_PERC,KC_KP_SLASH,_______,_______,KC_NO,KC_KP_7,KC_KP_8,KC_KP_9,KC_KP_ASTERISK,_______,KC_COLN,KC_KP_4,KC_KP_5,KC_KP_6,KC_KP_MINUS,_______,_______,KC_COMMA,KC_KP_1,KC_KP_2,KC_KP_3,KC_KP_PLUS,_______,KC_0,KC_0,KC_DOT,KC_KP_ENTER,_______,_______,_______,_______,_______,_______,_______),

  [5] = LAYOUT_ergodox(_______,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,_______,_______,KC_EXLM,KC_AT,KC_LCBR,KC_RCBR,KC_PERC,_______,_______,KC_HASH,KC_UNDS,KC_LPRN,KC_RPRN,KC_AMPR,_______,KC_BSLASH,KC_SLASH,KC_LBRACKET,KC_RBRACKET,KC_TILD,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,KC_F6,KC_F7,KC_F8,KC_F9,KC_F10,KC_F11,_______,KC_CIRC,KC_KP_PLUS,KC_KP_MINUS,KC_GRAVE,KC_SCOLON,_______,KC_PIPE,KC_EQUAL,KC_QUOTE,KC_COLN,KC_DQUO,_______,_______,KC_DLR,KC_ASTR,KC_LABK,KC_RABK,KC_QUES,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______),

  [6] = LAYOUT_ergodox(_______,_______,_______,LALT(LCTL(KC_C)),_______,_______,_______,_______,LALT(LCTL(KC_U)),LALT(LCTL(LGUI(KC_LEFT))),LALT(LCTL(KC_ENTER)),LALT(LCTL(LGUI(KC_RIGHT))),LALT(LCTL(KC_I)),_______,_______,LALT(LCTL(KC_J)),LALT(LCTL(KC_LEFT)),LALT(LCTL(KC_BSPACE)),LALT(LCTL(KC_RIGHT)),LALT(LCTL(KC_K)),_______,KC_UP,LALT(LCTL(KC_E)),LALT(LCTL(KC_F)),LALT(LCTL(KC_T)),LALT(LCTL(KC_G)),_______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,LALT(LCTL(KC_C)),_______,_______,_______,_______,LALT(LCTL(KC_U)),LALT(LCTL(LGUI(KC_LEFT))),LALT(LCTL(KC_ENTER)),LALT(LCTL(LGUI(KC_RIGHT))),LALT(LCTL(KC_I)),_______,LALT(LCTL(KC_J)),LALT(LCTL(KC_LEFT)),LALT(LCTL(KC_BSPACE)),LALT(LCTL(KC_RIGHT)),LALT(LCTL(KC_K)),_______,_______,LALT(LCTL(KC_D)),LALT(LCTL(KC_E)),LALT(LCTL(KC_F)),LALT(LCTL(KC_T)),KC_UP,_______,_______,_______,KC_LEFT,KC_DOWN,KC_RIGHT,_______,_______,_______,_______,_______,_______),

  [7] = LAYOUT_ergodox(_______,KC_F14,KC_F15,_______,_______,_______,RESET,_______,_______,_______,KC_MS_UP,_______,_______,_______,_______,_______,KC_MS_LEFT,KC_MS_DOWN,KC_MS_RIGHT,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,RGB_MOD,HSV_0_255_255,HSV_120_255_128,KC_MS_BTN1,KC_MS_BTN2,HSV_240_255_255,_______,_______,_______,_______,_______,_______,KC_MEDIA_EJECT,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,RGB_TOG,RGB_SLD,RGB_VAI,RGB_VAD,RGB_HUD,RGB_HUI),

  [8] = LAYOUT_ergodox(_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,DYN_REC_START2,DYN_MACRO_PLAY2,DYN_REC_STOP,_______,_______,_______,DYN_REC_START1,DYN_MACRO_PLAY1,DYN_REC_STOP,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______,_______),
...
void keyboard_post_init_user(void) {
  // Use this hook to run code on startup
  // layer_on(QWERTY);
}